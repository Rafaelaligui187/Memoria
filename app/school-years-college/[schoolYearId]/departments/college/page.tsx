...
export default function CollegeDepartmentPage({ params }: { params: { schoolYearId: string } }) {
  ...
  useEffect(() => {
    const fetchCourses = async () => {
      try {
        ...
        console.log('Fetching courses for schoolYearId:', params.schoolYearId)
  ...
  // Listen for course updates from localStorage (for real-time updates)
  useEffect(() => {
      ...
      <div className="relative bg-gradient-to-r from-purple-600 to-indigo-700 py-20 px-4 sm:px-6 lg:px-8 text-white">
        <div className="relative max-w-7xl mx-auto">
          ...
          <p className="mt-6 max-w-3xl text-xl">
            Preparing students for professional careers through specialized academic programs and industry-focused education.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {coursesLoading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="bg-white rounded-lg shadow-md overflow-hidden border border-purple-100 h-full flex flex-col animate-pulse">
          ...
          <div className="text-center py-12">
            <div className="bg-white rounded-lg shadow-md p-8 border border-purple-100">
              ...
              <p className="text-gray-600 mb-4">No courses have been created for this school year yet.</p>
              <p className="text-sm text-gray-500">Courses will appear here once an admin adds them.</p>
            </div>
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {courses.map((course) => (
              <Link key={course._id} href={`/school-years-college/${params.schoolYearId}/departments/college/${course._id}`}>
                <div className="bg-white rounded-lg shadow-md overflow-hidden transition-transform duration-300 hover:shadow-lg hover:-translate-y-1 border border-purple-100 h-full flex flex-col">
                  <div className="h-40 overflow-hidden">
                    <img
                      src={`/placeholder.svg?height=200&width=300&text=${encodeURIComponent(course.name)}`}
                      alt={course.name}
                  ...
                  <div className="p-6 flex-grow">
                    ...
                    <p className="text-sm text-gray-600 mb-4">{course.tagline || course.fullName || course.description}</p>
                    <div className="mt-4 pt-4 border-t border-purple-100">
          ...
          <div className="lg:flex lg:items-center lg:gap-12">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Our College Department offers specialized academic programs designed to prepare students for
                professional careers. Through a comprehensive curriculum and industry partnerships, we help
                students develop the skills and knowledge they need to succeed in their chosen fields.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                With experienced faculty and modern facilities, we ensure that our students receive quality education
                and practical experience that will give them a competitive edge in the professional world.
              </p>
              <div className="flex flex-wrap gap-4 mt-8">
                ...
                <div className="bg-white p-4 rounded-lg shadow-sm border border-purple-100 flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Tailored to each academic program</p>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm border border-purple-100 flex items-center">
                  <div className="bg-purple-100 p-3 rounded-full mr-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Professional Preparation</h3>
                    <p className="text-sm text-gray-600">Guidance for career development and industry readiness</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="mt-10 lg:mt-0 lg:w-1/2">
              <img
                src="/placeholder.svg?height=400&width=600&text=College+Students"
