...
export default function SchoolYearsCollegePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
      ...
      {/* Hero Section */}
      <div className="relative bg-gradient-to-r from-purple-600 to-indigo-600 py-24 px-4 sm:px-6 lg:px-8 text-white">
              ...
              >
                <div>
                  ...
                  <div className="flex items-center text-gray-600">
                    ...
                    <span>College Yearbook Records</span>
                    {year.isActive && (
                ...
                <Link
                  href={`/school-years-college/${year._id}/departments/college`}
          ...
          <div className="lg:flex lg:items-center lg:gap-12">
            <div className="lg:w-1/2">
              ...
              <p className="text-lg text-gray-700 mb-6">
                Our College Department offers comprehensive degree programs designed to prepare students for
                professional careers and advanced studies. Through rigorous academic training, practical
                experiences, and industry partnerships, we equip students with the knowledge and skills
                needed to excel in their chosen fields.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                With experienced faculty, modern facilities, and a commitment to academic excellence,
                we provide a transformative educational experience that prepares students for success
              ...
              <div className="flex flex-wrap gap-4 mt-8">
                <div className="bg-white p-4 rounded-lg shadow-sm border border-purple-100 flex items-center">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Industry-Ready Programs</h3>
                    <p className="text-sm text-gray-600">Curriculum aligned with industry standards</p>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm border border-purple-100 flex items-center">
                  <div className="bg-purple-100 p-3 rounded-full mr-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Experienced professors and industry professionals</p>
                  </div>
                </div>
                <div className="bg-white p-4 rounded-lg shadow-sm border border-purple-100 flex items-center">
                  <div className="bg-purple-100 p-3 rounded-full mr-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900">Career Preparation</h3>
                    <p className="text-sm text-gray-600">Comprehensive career guidance and placement support</p>
                  </div>
                </div>
              </div>
            </div>
