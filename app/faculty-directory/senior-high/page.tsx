...
const facultyData = [
  ...
  {
    id: 305,
    name: "Ms. Isabelle Garcia",
    position: "GAS Strand Coordinator",
    photo: "/placeholder.svg?height=300&width=300&text=Ms.+Garcia",
    email: "isabelle.garcia@example.com",
    phone: "(123) 456-8205",
    education: "Master's in Education, De La Salle University",
    bio: "Ms. Garcia helps GAS students explore various academic disciplines to discover their interests and strengths.",
  },
  {
    id: 306,
    name: "Mr. Diego Tan",
  ...
  {
    id: 307,
    name: "Ms. Sophia Fernandez",
    position: "Arts and Design Strand Coordinator",
    photo: "/placeholder.svg?height=300&width=300&text=Ms.+Fernandez",
    email: "sophia.fernandez@example.com",
    phone: "(123) 456-8207",
    education: "Master's in Fine Arts, University of the Philippines",
    bio: "Ms. Fernandez nurtures creative talents and helps students develop portfolios for art and design careers.",
  },
  {
    id: 308,
    name: "Dr. Marco Reyes",
