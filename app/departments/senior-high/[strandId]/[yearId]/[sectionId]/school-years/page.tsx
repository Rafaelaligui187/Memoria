...
export default function SeniorHighSchoolYearSelectionPage({
  ...
  > = {
    ...
    he: {
      short: "HE",
      full: "Home Economics",
      tagline: "CREATE, SERVE, EXCEL",
    },
    ict: {
      short: "ICT",
      full: "Information and Communications Technology",
      tagline: "INNOVATE, DEVELOP, CONNECT",
    },
  }
  ...
  const sectionNames: Record<string, string> = {
    "section-1": `${strand.short} 1`,
    "section-2": `${strand.short} 2`,
    "section-3": `${strand.short} 3`,
    "section-4": `${strand.short} 4`,
    "section-5": `${strand.short} 5`,
  }
          ...
          <div className="space-y-8">
            {schoolYears.map((year) => (
              ...
              >
                ...
                <Link
                  href={`/school-years-senior-high/${year._id}/departments/senior-high/${params.strandId}/${params.yearId}/${params.sectionId}/yearbook`}
