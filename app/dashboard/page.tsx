        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 rounded-2xl p-10 text-white relative overflow-hidden shadow-xl">
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center text-base bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 w-fit">
                <div className="w-3 h-3 bg-white rounded-full mr-3"></div>
                <span className="font-medium">Student ID: {user?.schoolId || "2023001"}</span>
              </div>
            </div>
          </div>
        </div>
