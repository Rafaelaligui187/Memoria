...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log("[v0] Login attempt:", { identifier, isAdminCredentials })
      ...
      if (isAdminCredentials) {
        ...
        if (success) {
          ...
          setTimeout(() => {
            ...
            console.log("[v0] User data after admin login:", userData)
            router.push("/admin")
          }, 100)
        } else {
        ...
        console.log("[v0] Regular user login attempt")
