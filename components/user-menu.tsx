...
import { Settings, MessageSquare, Trash2, Edit, UserPlus, ChevronDown, LogOut } from "lucide-react"
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-64 p-2">
          ...
          <DropdownMenuItem onClick={() => setShowProfileSetup(true)} className="px-2 py-2.5 cursor-pointer">
