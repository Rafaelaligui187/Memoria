...
export function ReportsManagement({ selectedYear }: ReportsManagementProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Handle user reports and messages for {selectedYear}</p>
        </div>
      </div>
