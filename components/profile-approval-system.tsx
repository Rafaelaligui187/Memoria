...
const mockSubmissions: ProfileSubmission[] = [
  ...
  },
  {
    ...
    rejectionReason: "Incomplete information - missing current profession details",
    yearId: "2024-2025",
    profileData: {
      fullName: "Jane Smith",
      nickname: "Jane",
      ...
      socialMediaFacebook: "@jane.smith",
      socialMediaInstagram: "@janesmith",
      socialMediaTwitter: "@janetech",
      profilePictureUrl: "",
  ...
  },
  {
    ...
    userId: "user4",
    userName: "Ana Reyes",
    userEmail: "ana.reyes@example.com",
    role: "Staff",
