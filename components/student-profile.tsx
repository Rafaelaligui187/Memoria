        ...
        <Tabs defaultValue="profile" className="w-full">
          ...
          <TabsContent value="profile" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              {/* Sidebar Info - Academic Information */}
              <Card className="p-5">
                <h2 className="text-lg font-semibold mb-4 flex items-center">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="font-medium">{student.department || departmentName}</p>
                  </div>
                  {student.yearLevel && (
                    <div>
                      <p className="text-sm text-gray-500">Year Level</p>
                      <p className="font-medium">{student.yearLevel} Year</p>
                    </div>
                  )}
                  {(student.course || student.courseProgram) && (
                    <div>
                      <p className="text-sm text-gray-500">Course/Program</p>
                      <p className="font-medium">{student.course || student.courseProgram}</p>
                    </div>
                  )}
                  <div>
                    <p className="text-sm text-gray-500">Section/Block</p>
                    <p className="font-medium">{student.blockSection || student.sectionBlock || sectionInfo.name}</p>
                  </div>
                  <div>
                  ...
                  {student.honors && (
                    <div>
                      ...
                      <p className="font-medium">{student.honors}</p>
                    </div>
                  )}
                  {student.officerRole && student.officerRole !== "None" && (
                    <div>
                      <p className="text-sm text-gray-500">Officer Role</p>
                      <p className="font-medium">{student.officerRole}</p>
                    </div>
                  )}
                  {sectionInfo.adviser && (
                    <div>
            ...
            <Card className="p-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <p className="text-gray-700">{sectionInfo.academicYear}</p>
                </div>
