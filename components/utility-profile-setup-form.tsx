...
interface UtilityProfileSetupFormProps {
  schoolYearId: string
  userId: string
  isEditing?: boolean
  onBack: () => void
...
export function UtilityProfileSetupForm({
  schoolYearId,
  userId,
  isEditing = false,
  onBack,
  onSave,
}: UtilityProfileSetupFormProps) {
  ...
  const validateForm = () => {
    ...
    if (!formData.officeAssigned.trim()) newErrors.officeAssigned = "Office is required"
    if (!formData.yearsOfService.trim()) newErrors.yearsOfService = "Years of service is required"

    // Debug logging
    console.log("[Utility Form] Validation check:", {
      formData,
      newErrors,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        toast({
          title: "Success",
          description: "Utility profile created successfully!",
        })
        onSave()
      } else {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold">Utility Profile Setup</h2>
          </div>
        </div>
      ...
      <Card className="p-6">
        ...
        <CardContent className="px-0 pb-0 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="officeAssigned">Office *</Label>
              <Select value={formData.officeAssigned} onValueChange={(value) => handleInputChange("officeAssigned", value)}>
              ...
              {errors.officeAssigned && <p className="text-sm text-red-500">{errors.officeAssigned}</p>}
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Share a message with students"
