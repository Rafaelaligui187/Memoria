...
interface StaffProfileSetupFormProps {
  schoolYearId: string
  userId: string
  isEditing?: boolean
  onBack: () => void
...
export function StaffProfileSetupForm({
  schoolYearId,
  userId,
  isEditing = false,
  onBack,
  onSave,
}: StaffProfileSetupFormProps) {
  ...
  const validateForm = () => {
    ...
    // Debug logging
    console.log("[Staff Form] Validation check:", {
      formData,
      newErrors,
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold">Staff Profile Setup</h2>
          </div>
        </div>
