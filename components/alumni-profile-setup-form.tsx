...
interface AlumniProfileSetupFormProps {
  schoolYearId: string
  userId: string
  isEditing?: boolean
  onBack: () => void
...
export function AlumniProfileSetupForm({
  schoolYearId,
  userId,
  isEditing = false,
  onBack,
  onSave,
}: AlumniProfileSetupFormProps) {
  ...
  const validateForm = () => {
    ...
    // Debug logging
    console.log("[Alumni Form] Validation check:", {
      formData,
      newErrors,
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-semibold">Alumni Profile Setup</h2>
          </div>
        </div>
        ...
        <CardContent className="px-0 pb-0 space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              />
              {errors.currentProfession && <p className="text-sm text-red-500">{errors.currentProfession}</p>}
            </div>
            <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Share advice or message with current students"
        ...
        <CardContent className="px-0 pb-0 space-y-4">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <Textarea
                id="achievements"
                placeholder="List your achievements since graduation"
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="activities"
                placeholder="Tell us about your activities and involvement"
